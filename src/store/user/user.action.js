import { USER_ACTION_TYPES } from "./uesr.types";
...
export const signUpSuccess = (user, addtionDetails) => createAction(USER_ACTION_TYPES.SIGN_UP_SUCCESS, {user, addtionDetails});
